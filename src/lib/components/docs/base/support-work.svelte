...
<!-- {#if isHovered} -->
	<a
		href="https://bhide.dev?utm_source=animations&utm_medium=referral&utm_campaign=sponsor"
		target="_blank"
...
<Card.Root
	...
	class="relative z-50 gap-2 border border-emerald-500 bg-emerald-50 py-4 shadow-none ring-0 dark:border-emerald-700/60 dark:bg-emerald-900/30"
>
	...
	<Card.Content class="mt-2 border-none px-4!">
		<Button
			class="hover:bg-green-450! w-full bg-green-400! font-mono text-green-900 hover:text-green-950/90 dark:text-green-950"
			target="_blank"
			variant="outline"
