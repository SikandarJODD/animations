<script lang="ts">
	...
	import { randomLetterSwapInstallation, randomLetterSwapPingPongInstallation } from "./data";
...
<div class="space-y-6 md:space-y-8">
	...
	<section>
		...
		<div class="bg-secondary/30 mt-4 rounded-xl border p-2">
			...
			<InstallComponent
				installUrl={installRandomLetterSwap}
				codeBlocks={randomLetterSwapInstallation.installCode}
				packages={randomLetterSwapInstallation.packages}
				folderStructure={randomLetterSwapInstallation.folderStructure}
				class="mt-2"
			/>
		</div>
		<div class="bg-secondary/30 relative mt-4 rounded-xl border p-2">
			...
			<InstallComponent
				installUrl={installRandomLetterSwapPingPong}
				codeBlocks={randomLetterSwapPingPongInstallation.installCode}
				packages={randomLetterSwapPingPongInstallation.packages}
				folderStructure={randomLetterSwapPingPongInstallation.folderStructure}
				class="mt-2"
			/>
		</div>
		...
		<Item.Root variant="muted" class="mt-4">
			...
			<Item.Actions>
				<Button
					...
					size="sm"
					target="_blank"
					href="https://www.fancycomponents.dev/docs/components/text/random-letter-swap#understanding-the-component"
				>
					Docs
					<svg
