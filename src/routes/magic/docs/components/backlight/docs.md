...
# bun
bun x shadcn-svelte@latest add https://sv-animations.vercel.app/r/backlight.json
```
...
<Backlight blur={5}>
	<!-- Svelte Logo from: https://svgl.app/?search=svelte -->
	<svg class="size-20" viewBox="0 0 256 308" preserveAspectRatio="xMidYMid">
		<path
